  ...
  return (
    <UserContext.Provider value={{auth, setAuth}}>
      ...
      <Route path="/" element={ <PrivateRoute Component={CoursesWithContext} /> } />
        ...
        <Route path="/signin" element={<PrivateRoute Component={UserSignInWithContext} />} />
        <Route path="/signup" element={<PrivateRoute Component={UserSignUpWithContext} />} />
        <Route path="/signout" element={<PrivateRoute Component={UserSignOutWithContext} />} />
